...
class BeersControllerTest < ActionController::TestCase
  ...
  test "should create beer" do
    assert_difference('Beer.count') do
      post :create, beer: { info: @beer.info, location: @beer.location, name: @beer.name, price: @beer.price }
    end
  ...
  test "should update beer" do
    put :update, id: @beer, beer: { info: @beer.info, location: @beer.location, name: @beer.name, price: @beer.price }
    assert_redirected_to beer_path(assigns(:beer))
  end
